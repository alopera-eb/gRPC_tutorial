...
class RecommendationService(recommendations_pb2_grpc.RecommendationsServicer):
    """
        Defines the microservice implementation
    """
...
def serve():
    ...
    # Associate your class with the server (like adding a handler for requests)
    recommendations_pb2_grpc.add_RecommendationsServicer_to_server(RecommendationService(), server)
    server.add_insecure_port("[::]:50051")
    # Start the microservic and wait for termination
    server.start()
